...
const db = new Database('./src/db/database.db', './src/db/databaseComments.db',{
...
server.get('/movie/:movieId', (req, res) => {
  console.log(req.params.postId); //Show URL params
  const postId = req.params.postId; //movie id that we get by qparams
...
server.post('/sign-up', (req, res) => {
  ...
  const signUpUserName = req.body.email;
